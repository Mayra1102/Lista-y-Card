...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.helado, "Helado", "Helado"));
        items.add(new ItemsList(R.mipmap.pastel, "Papas", "Papas"));
        items.add(new ItemsList(R.mipmap.paletas, "Paletas", "Paletas"));
        items.add(new ItemsList(R.mipmap.pizza, "Pizza", "Pizza"));
        items.add(new ItemsList(R.mipmap.papas, "Flan", "Flan"));
